...
class PayPanelHostingUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('paypanel_hosting_err_ns');
        }
...
return 'PayPanelHostingUpdateProcessor';
