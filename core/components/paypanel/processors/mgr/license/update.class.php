...
class PayPanelLicenseUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('paypanel_license_err_ns');
        }
...
return 'PayPanelLicenseUpdateProcessor';
